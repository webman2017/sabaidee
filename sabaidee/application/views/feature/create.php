            ...
            <div id="content">
                ...
                <div class="container-fluid mb-2 bg-white">
                    <div class="col-12 backtxt pt-2 pb-2">
                        <div class="mb-2">
                            <i class="far fa-star"></i> เพิ่มลักษณะสินค้า
                        </div>
                        <div class="smtxt mt-2 mb-2">
                            หน้าหลัก / เพิ่มลักษณะสินค้า
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <form action="" method="post" enctype='multipart/form-data' id="feature_form">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-7">
                                                <div class="form-group">
                                                    <input type="text" class="form-control smtxt" placeholder="ระบุลักษณะสินค้า" name="feature_name" id="feature_name">
                                                </div>
                                            </div>
                                        </div>
                                         <div class="row">
                                            ...
                                            <div class="col-7">
                                                <div class="form-group">
                                                    <textarea  class="form-control smtxt" placeholder="รายละเอียด" name="feature_description" id="feature_description"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
    ...
    <script>
        $('#save').click(function() {
            if ($('#pd_name').val() == "") {
                ...
                var formdata = $("#feature_form").serialize();
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('save_feature'); ?>",
                    data: formdata,
                    cache: false,
                    dataType: "json",
