            ...
            <div id="content">
                ...
                <div class="container-fluid mb-2 bg-white">
                    <div class="col-12 backtxt">
                        <div>
                            <i class="far fa-folder"></i> หมวดหมู่สินค้า
                        </div>
                        <div class="smtxt">
                            ...
                            <table class="table table-bordered  table-hover" id='postsList'>
                                <thead>
                                    <tr>
                                        ...
                                        <td class="tbtxt" width="20%">แก้ไข</td>
                                        <td class="tbtxt" width="20%">ลบ</td>
                                    </tr>
                                </thead>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title backtxt">แก้ไขหมวดหมู่สินค้า</h5>
                        ...
                        <div class="modal-body">
                            <div class="form-group tbtxt">
                                ...
                                <input type="text" name="category_name" id="category_name" class="form-control smtxt"
                                    placeholder="ระบุชื่อหมวดหมู่สินค้า">
                            </div>
                            <!-- <div class="form-group tbtxt">
                                รหัสหมวดหมู่
                                <input type="text" name="product_code" id="product_code" class="form-control smtxt"
                                    placeholder="ระบุรหัสหมวดหมู่สินค้า">
                            </div> -->
                            <!-- <div class="form-group tbtxt">
                                รูปภาพ
...
$(document).ready(function() {
    ...
    function loadPagination(pagno) {
        $.ajax({
            url: '<?php echo base_url(); ?>/Category/loadRecord/' + pagno,
            type: 'get',
            dataType: 'json',
            beforeSend: function() {
    ...
    function createTable(result, sno) {
        ...
        for (index in result) {
            ...
            tr += "<td>" + sno + "</td>";
            tr += "<td class='num'>" + result[index].category_name + "</td>";
            tr +=
            ...
            tr +=
                "<td><button class='btn btn-sm btn-danger border'><i class='fa fa-trash-o' aria-hidden='true'></i></button></td>";
            "</td>";
            tr += "</tr>";
