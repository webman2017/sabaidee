...
$route['create_category']='Category/create_category';
$route['save_category']='Category/save_category';
$route['update_category']='Category/update_category';

$route['create_feature']='Feature/create_feature';

$route['save_feature']='Feature/save_feature';
$route['product_shop/(:any)']='Shop/product_shop/$1';
...
$route['feature_update']='Products/feature_update';
