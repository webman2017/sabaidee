            ...
            <div id="content">
                ...
                <div class="container-fluid mb-2 bg-white">
                    <div class="col-12 backtxt">
                        <div>
                            <i class="fa fa-cubes m-r-xs"></i> รายการสินค้า
                        </div>
                        <div class="smtxt">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-sm smtxt"
                                            placeholder="ระบุรหัสสินค้า,ระบุชื่อสินค้า" id="product_search">
                                    </div>
                                </div>
                                <div class="col-2">
                                ...
                                <div class="col-2">
                                    <a class="btn btn-success txtbtn"
                                        href="<?php echo base_url('export_product');?>">Excel</a>
                                </div>
                            </div>
                            ...
                            <table class="table table-bordered  table-hover">
                                <tr>
                                    ...
                                    <!-- <td class="tbtxt" width="20%">วันที่สร้าง</td> -->
...
if(!empty($results)){
    $no=1;?>
                                <tbody id="result">
                                    ...
                                    <tr class="trtxt">
                                        <td><?php echo $no;?></td>
                                        <td><?php echo $data->pd_code;?></td>
                                        <td>
                                            <?php if($data->pd_image !="" || $data->pd_image !=NULL){;?>
                                            <img src="<?php echo base_url('upload/');?><?php echo $data->pd_image;?>"
                                                height='80'>
                                            <?php }else{;?>
                                        ...
                                        <td>
                                            <div><a href="<?php base_url('product_preview/');?><?php echo $data->pd_id;?>"
                                                    class='smtxt'><?php echo $data->pd_name;?></a></div>
                                        </td>
                                        <td><?php echo $data->pd_price;?></td>
                                        <td>
                                            <button class='btn btn-warning txtbtn edit' id="<?php echo $data->pd_id;?>"
                                                product_name="<?php echo $data->pd_name;?>"
                                                code="<?php echo $data->pd_code;?>"
                                                img="<?php echo $data->pd_image;?>"><i class='fas fa-pencil-alt'></i>
                                                แก้ไข</button>
                                            <button class='btn btn-danger txtbtn del' id="<?php echo $data->pd_id;?>"><i
                                                    class='fa fa-trash' aria-hidden='true'></i> ลบ</button>
                                        </td>
                                    </tr>
                                ...
                                <tr class="trtxt text-center">
                                    <td colspan="9">ไม่พบรายการสินค้า</td>
                                </tr>
                                <?php }
?>
                            </table>
                            <p><?php echo $links_set; ?></p>
