        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row mb-2">
                        <div class="col-6">รายการสั่งซื้อใหม่</div>
                        ...
                        <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="form-group">
                                                การชำระเงิน
                                                <select class="form-control form-control-sm">
                                                    <option>เลือกวิธีการชำระเงิน</option>
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                พนักงานขาย
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <input type="text" class="form-control form-control-sm" placeholder="ชื่อสินค้า ค้นหาสินค้า">
                                            <button class="btn btn-success btn-sm">ค้นหา</button>
                                        </div>
                                    </div>
                                    ...
                                     <button class="btn btn-success btn-sm">บันทึก</button>
                                     <button class="btn btn-success btn-sm">บันทึกและสร้างใหม่</button>
                                    <button class="btn btn-danger btn-sm">ยกเลิก</button>
                                </div>
                            </div>
                        </div>
